...
| TD-004 | 2026-06-05 | ~~**Audit Log — Trazabilidad completa de mutaciones**. Tabla `audit_log` con full diff (before/after JSON) para toda mutación. Implementación en storage.py (misma transaction = atomicidad). Sin CLI — queryable via DB. 24 funciones mutantes, 24 test cases. Ver [PLAN-TD004.md](PLAN-TD004.md)~~ | Alta | ✅ Implementado |
